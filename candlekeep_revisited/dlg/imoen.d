...
== %bg1_imoen_dlg% IF ~IsValidForPartyDialog("%bg1_imoen%")~ THEN ~Wow, that much gold for just running back and forth for a sword? Maybe I should try to arrange for his sword to 'disappear' for a bit then happen to 'find' it, what d'ya think?~
END

I_C_T2 HULL 3 C0CandleReImoenInterjectHull
== %bg1_imoen_dlg% IF ~IsValidForPartyDialog("%bg1_imoen%")~ THEN ~Whoa, looks like someone woke up on the wrong side of the bed this morning. Don't worry, <CHARNAME>, I'm sure the verbal whipping the Gatewarden's gonna give him will be way harsher than what he's saying to you. And maybe I'll slip some coins out of his purse too, heh heh.~
END

I_C_T2 INNKE2 6 C0CandleReImoenInterjectWinthrop
== INNKE2 IF ~IsValidForPartyDialog("%bg1_imoen%")~ THEN ~Oho, and I see a familiar face taggin' along with you too. Imoen, girl, does my memory fail me, or did I not entrust you with the cleanin' of the rooms upstairs, eh?~
== %bg1_imoen_dlg% ~Puffguts! Um... I'll get to it... later! Yeah, just need to find, um... a cleaning rag somewhere...~
...
== %bg1_imoen_dlg% ~Aww... come on. Alright, alright... I'll get to it after I'm done sendin' off <CHARNAME>.~
